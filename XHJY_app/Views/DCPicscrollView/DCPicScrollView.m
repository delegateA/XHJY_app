...
- (instancetype)initWithFrame:(CGRect)frame WithImageNames:(NSArray<NSString *> *)ImageName withButton:(BOOL)isHave {
...
- (void)addBtnToView
{
    ...
    self.closeBtn.frame = CGRectMake(60, 60, 30, 30);
    [self.closeBtn addTarget:self action:@selector(buttonDidTap) forControlEvents:UIControlEventTouchUpInside];
...
- (void)buttonDidTap
{
    if (self.buttonDidTapAtIndex != nil) {
        self.buttonDidTapAtIndex(_currentIndex);
    }
}
