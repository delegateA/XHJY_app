...
- (void)awakeFromNib
{
    [_backView setBackgroundColor:[Tools colorWithHexString:[Singleton sharedInstance].mainColor withAlpha:1]];
    [_collectionView setBackgroundColor:[Tools colorWithHexString:[Singleton sharedInstance].mainColor withAlpha:1]];
    [_collectionView registerClass:[SZCalendarCell class] forCellWithReuseIdentifier:SZCalendarCellIdentifier];
    [_line setBackgroundColor:[Tools colorWithHexString:[Singleton sharedInstance].lineColor withAlpha:1]];
     _weekDayArray = @[@"Sun",@"Mon",@"Tue",@"Web",@"Thu",@"Fri",@"Sat"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        [cell.dateLabel setTextColor:RGBCOLOR(170, 237, 227)];
    } else {
        ...
        if (i < firstWeekday) {
             ...
             NSDate *ldate = [self nextMonth:self.date];
            NSInteger ldaysInThisMonth = [self totaldaysInMonth:ldate];
            
            [cell.dateLabel setText:[[NSString alloc]initWithFormat:@"%ld",ldaysInThisMonth - firstWeekday + i]];
            [cell.dateLabel setTextColor:RGBCOLOR(170, 237, 227)];
            
        }else if (i > firstWeekday + daysInThisMonth - 1)
        
        {
            [cell.dateLabel setText:[[NSString alloc]initWithFormat:@"%ld",i - firstWeekday - daysInThisMonth + 1]];
            [cell.dateLabel setTextColor:RGBCOLOR(170, 237, 227)];
        }
        else{
