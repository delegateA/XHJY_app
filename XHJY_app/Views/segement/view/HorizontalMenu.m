...
//按钮默认颜色
#define GRAY_COLOR_16 [UIColor whiteColor]
//按钮选中颜色
#define BLUE_COLOR_16 [UIColor whiteColor]
...
//    CGSize size = [Utility sizeWithText:_tmpBtn.titleLabel.text font:_tmpBtn.titleLabel.font maxSize:CGSizeMake(MAXFLOAT, MAXFLOAT)];
    ...
    _selectLine.backgroundColor = [Tools colorWithHexString:@"#6760a8" withAlpha:1];
