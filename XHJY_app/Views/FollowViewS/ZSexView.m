...
@interface ZSexView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation ZSexView

+(ZSexView *)instanceDatePickerView{
    NSArray *nibView=[[NSBundle mainBundle]loadNibNamed:@"ZSexView" owner:nil options:nil];
...
- (IBAction)sureBtn:(UIButton *)sender {
    ...
    //delegate
    [self.delegate getSelectSex:self.sureStr];
